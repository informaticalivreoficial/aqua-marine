    ...
    <section class="section-height-800 breadcrumb-modern rd-parallax context-dark bg-gray-darkest text-lg-left">
        ...
        <div class="bg-primary-chathams-blue-reverse">
            ...
            <div class="veil reveal-md-block">
                <h1 class="text-bold">Roteiros</h1>
            </div>
                    ...
                    @foreach ($roteiros as $roteiro)
                        <div class="cell-xs-12 cell-sm-6 cell-md-4 offset-top-30 offset-sm-top-0">
                            ...
                            <div class="box-member-img-wrap">
                                <img src="{{$roteiro->cover()}}" width="480" height="550" alt="" class="img-responsive"/>
                            </div>
                                ...
                                <div class="box-member-caption">
                                    <div class="box-member-caption-inner">
                                        <div class="box-member-caption-wrap">
                                            <div class="box-member-title">
                                                <div class="h4 text-bold text-white">
                                                    <a href="{{route('web.roteiro', ['slug' => $roteiro->slug])}}">{{$roteiro->name}}</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="offset-top-20">
                                            <a href="{{route('web.roteiro', ['slug' => $roteiro->slug])}}" class="btn btn-ripe-lemon">Leia mais</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
