...
!(function (t, e) {
    ...
    function U(t, e) {
        return null !== e
            ? ((e.abbr = t),
              null != ii[t]
                  ? (M("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale"), (e = k(ii[t]._config, e)))
                  : null != e.parentLocale && (null != ii[e.parentLocale] ? (e = k(ii[e.parentLocale]._config, e)) : M("parentLocaleUndefined", "specified parentLocale is not defined yet")),
              (ii[t] = new T(e)),
              x(t),
              ii[t])
            : (delete ii[t], null);
    ...
    function B(t) {
        return Q(
            t.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function (t, e, n, i, s) {
                return e || n || i || s;
            })
        );
    }
        ...
        for (this._monthsParse || ((this._monthsParse = []), (this._longMonthsParse = []), (this._shortMonthsParse = [])), i = 0; 12 > i; i++) {
            if (
                ...
                n &&
                    ...
                    ((this._longMonthsParse[i] = new RegExp("^" + this.months(s, "").replace(".", "") + "$", "i")), (this._shortMonthsParse[i] = new RegExp("^" + this.monthsShort(s, "").replace(".", "") + "$", "i"))),
            ...
            n &&
                ...
                ((e =
                    n[Wi] < 0 || n[Wi] > 11
                        ...
                        ? xi
                        : n[Ui] < 0 || n[Ui] > 24 || (24 === n[Ui] && (0 !== n[Gi] || 0 !== n[Pi] || 0 !== n[Ci]))
                        ? Ui
                        : n[Gi] < 0 || n[Gi] > 59
                        ? Gi
                        : n[Pi] < 0 || n[Pi] > 59
        ...
        if (!t._d) {
            for (
                i = wt(t),
                    ...
                    t._dayOfYear && ((s = Yt(t._a[Oi], i[Oi])), t._dayOfYear > yt(s) && (d(t)._overflowDayOfYear = !0), (n = _t(s, 0, t._dayOfYear)), (t._a[Wi] = n.getUTCMonth()), (t._a[xi] = n.getUTCDate())),
                    e = 0;
                3 > e && null == t._a[e];
                ++e
            )
            ...
            24 === t._a[Ui] && 0 === t._a[Gi] && 0 === t._a[Pi] && 0 === t._a[Ci] && ((t._nextDay = !0), (t._a[Ui] = 0)),
    ...
    function Tt(t) {
        ...
        (e = t._w),
            null != e.GG || null != e.W || null != e.E
                ? ((r = 1), (a = 4), (n = Yt(e.GG, t._a[Oi], Mt(Ft(), 1, 4).year)), (i = Yt(e.W, 1)), (s = Yt(e.E, 1)), (1 > s || s > 7) && (u = !0))
                : ((r = t._locale._week.dow),
                  (a = t._locale._week.doy),
                  (n = Yt(e.gg, t._a[Oi], Mt(Ft(), r, a).year)),
                  (i = Yt(e.w, 1)),
                  null != e.d ? ((s = e.d), (0 > s || s > 6) && (u = !0)) : null != e.e ? ((s = e.e + r), (e.e < 0 || e.e > 6) && (u = !0)) : (s = r)),
            1 > i || i > St(n, r, a) ? (d(t)._overflowWeeks = !0) : null != u ? (d(t)._overflowWeekday = !0) : ((o = Dt(n, i, s, r, a)), (t._a[Oi] = o.year), (t._dayOfYear = o.dayOfYear));
    }
    function bt(e) {
        ...
        for (s = $(e._f, e._locale).match(ri) || [], n = 0; n < s.length; n++)
            (r = s[n]),
                (i = (o.match(J(r, e)) || [])[0]),
                i && ((a = o.substr(0, o.indexOf(i))), a.length > 0 && d(e).unusedInput.push(a), (o = o.slice(o.indexOf(i) + i.length)), (l += i.length)),
                ui[r] ? (i ? (d(e).empty = !1) : d(e).unusedTokens.push(r), tt(r, i, e)) : e._strict && !i && d(e).unusedTokens.push(r);
    ...
    function Wt(t) {
        ...
        for (s = 0; s < t._f.length; s++)
            (r = 0),
                ...
                (e._f = t._f[s]),
                bt(e),
                l(e) && ((r += d(e).charsLeftOver), (r += 10 * d(e).unusedTokens.length), (d(e).score = r), (null == i || i > r) && ((i = r), (n = e)));
        a(t, n || e);
    }
    function xt(t) {
        if (!t._d) {
    ...
    function zt(e, n) {
        ...
        return this.isValid()
            ? null != e
                ? ("string" == typeof e ? (e = Rt(Yi, e)) : Math.abs(e) < 16 && (e = 60 * e),
                  !this._isUTC && n && (i = jt(this)),
                  (this._offset = e),
                  (this._isUTC = !0),
                  null != i && this.add(i, "m"),
                  s !== e && (!n || this._changeInProgress ? ue(this, ne(e - s, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), t.updateOffset(this, !0), (this._changeInProgress = null))),
                  this)
                : this._isUTC
                ? s
                : jt(this)
    ...
    function ne(t, e) {
        ...
        return (
            It(t)
                ...
                : (o = Ki.exec(t))
                ? ((n = "-" === o[1] ? -1 : 1), (a = { y: 0, d: g(o[xi]) * n, h: g(o[Ui]) * n, m: g(o[Gi]) * n, s: g(o[Pi]) * n, ms: g(o[Ci]) * n }))
                : (o = ts.exec(t))
                ? ((n = "-" === o[1] ? -1 : 1), (a = { y: ie(o[2], n), M: ie(o[3], n), w: ie(o[4], n), d: ie(o[5], n), h: ie(o[6], n), m: ie(o[7], n), s: ie(o[8], n) }))
                : null == a
                ? (a = {})
                : "object" == typeof a && ("from" in a || "to" in a) && ((s = re(Ft(a.from), Ft(a.to))), (a = {}), (a.ms = s.milliseconds), (a.M = s.months)),
            (i = new Nt(a)),
    ...
    function re(t, e) {
        var n;
        return t.isValid() && e.isValid() ? ((e = Et(e, t)), t.isBefore(e) ? (n = se(t, e)) : ((n = se(e, t)), (n.milliseconds = -n.milliseconds), (n.months = -n.months)), n) : { milliseconds: 0, months: 0 };
    }
    function ae(t) {
    ...
    function oe(t, e) {
        return function (n, i) {
            var s, r;
            return (
                null === i || isNaN(+i) || (M(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period)."), (r = n), (n = i), (i = r)),
              ...
              i.isValid()
                  ? ((s = 6e4 * (i.utcOffset() - this.utcOffset())),
                    ...
                    "year" === e || "month" === e || "quarter" === e
                        ? ((a = pe(this, i)), "quarter" === e ? (a /= 3) : "year" === e && (a /= 12))
                        : ((r = this - i), (a = "second" === e ? r / 1e3 : "minute" === e ? r / 6e4 : "hour" === e ? r / 36e5 : "day" === e ? (r - s) / 864e5 : "week" === e ? (r - s) / 6048e5 : r)),
                    n ? a : y(a))
                  : NaN)
            : NaN;
    }
    ...
    function Se(t, e) {
        return this.isValid() && ((_(t) && t.isValid()) || Ft(t).isValid()) ? ne({ to: this, from: t }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate();
    }
    function Ye(t) {
        return this.from(Ft(), t);
    }
    function we(t, e) {
        return this.isValid() && ((_(t) && t.isValid()) || Ft(t).isValid()) ? ne({ from: this, to: t }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate();
    }
    function ke(t) {
        return this.to(Ft(), t);
    }
    ...
    function sn(t, e, n) {
        ...
        for (this._weekdaysParse || ((this._weekdaysParse = []), (this._minWeekdaysParse = []), (this._shortWeekdaysParse = []), (this._fullWeekdaysParse = [])), i = 0; 7 > i; i++) {
            if (
                ...
                this._weekdaysParse[i] || ((r = "^" + this.weekdays(s, "") + "|^" + this.weekdaysShort(s, "") + "|^" + this.weekdaysMin(s, "")), (this._weekdaysParse[i] = new RegExp(r.replace(".", ""), "i"))),
    ...
    function Vn() {
        var t,
            ...
            u = this._data;
        return (
            (r >= 0 && a >= 0 && o >= 0) || (0 >= r && 0 >= a && 0 >= o) || ((r += 864e5 * Ln(In(o) + a)), (a = 0), (o = 0)),
    ...
    (_s.add = es),
        ...
        (_s.zone = D("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/issues/1779", Zt));
    var ys = _s,
    ...
    (Ys._calendar = gs),
        ...
        (t.langData = D("moment.langData is deprecated. Use moment.localeData instead.", P));
    var ws = Math.abs,
        ks = En("ms"),
        Ts = En("s"),
        bs = En("m"),
    ...
    (Es.abs = Pn),
        ...
        (Es.locale = Te),
        (Es.localeData = be),
        (Es.toIsoString = D("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Qn)),
        (Es.lang = is),
        E("X", 0, 0, "unix"),
        E("x", 0, 0, "valueOf"),
        q("x", Mi),
